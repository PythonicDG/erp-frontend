      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          {activeStage ? (
            ...
            <div className="p-20 text-center text-slate-400">Select a stage to view details</div>
          )}
        </div>
        ...
        <div className="space-y-6">
          <Card title="Activity Timeline">
             <div className="space-y-6">
               ...
               {(!activeStage || activeStage.activities.length === 0) && <p className="text-xs text-slate-400 italic">No activity yet</p>}
             </div>
          </Card>
        </div>
      </div>
